...
CHROMIUM_VERSION="150.0.7871.186"
CHROMIUM_P="chromium-${CHROMIUM_VERSION}"
NODE_VERSION="24.21.0"
NODE_P="node-v${NODE_VERSION}"
UGC_PVR="150.0.7871.186-1"
...
#
		...
		#fi
		eapply_wrapper "${FILESDIR}/misc-fixes-r00.patch"
	...
	if use ungoogled; then
		...
		UGC_SKIP_SUBSTITUTION="${UGC_SKIP_SUBSTITUTION} flag-metadata.json histograms.xml \
			...
			graph_builder_tflite.cc password_manual_fallback_flow_unittest.cc packet_buffer.cc"
		...
		eapply_wrapper "${FILESDIR}/misc-fixes-ung-r4.patch"
	fi
	...
	do
		...
		for i in "${topatch[@]}"; do
			...
			if [ "$i" = "cherry-pick-dd8e2822e507.patch" ] ||
				...
				[ "$i" = "cherry-pick-9374abd8b25a.patch" ]||
				[ "$i" = "cherry-pick-349cc893f9ec.patch" ]||
				[ "$i" = "cherry-pick-e7059223305c.patch" ]||
				[ "$i" = "cherry-pick-315a6ad02de9.patch" ]||
				[ "$i" = "cherry-pick-4b7f62da7b54.patch" ]||
				[ "$i" = "cherry-pick-4de99209fb4f.patch" ]||
				[ "$i" = "cherry-pick-59438747bc13.patch" ]||
				[ "$i" = "cherry-pick-b94d422a6fdd.patch" ]||
				[ "$i" = "cherry-pick-5382ed032a48.patch" ]||
				[ "$i" = "cherry-pick-3a0ed7f623ee.patch" ]||
				[ "$i" = "cherry-pick-2c68772a0eb7.patch" ]||
				[ "$i" = "cherry-pick-8983f40bc8ef.patch" ]||
				[ "$i" = "cherry-pick-87f5655006e4.patch" ]||
				[ "$i" = "cherry-pick-e4b5328067a5.patch" ]||
				[ "$i" = "cherry-pick-b8986b4e67e7.patch" ]||
				[ "$i" = "cherry-pick-efa9616b48ae.patch" ]||
				[ "$i" = "cherry-pick-4d2a8274815f.patch" ]||
				[ "$i" = "cherry-pick-56378e95557b.patch" ]||
				[ "$i" = "cherry-pick-88cdab49ce29.patch" ]||
				[ "$i" = "cherry-pick-9abbc0c6d03f.patch" ]||
				[ "$i" = "cherry-pick-58b7849d7590.patch" ]||
				[ "$i" = "cherry-pick-8efd15f71c27.patch" ]||
				[ "$i" = "cherry-pick-107da744f62a.patch" ]||
				...
				[ "$i" = "cherry-pick-292e993b4a84.patch" ]||
				[ "$i" = "cherry-pick-a17d5224d83f.patch" ]||
				[ "$i" = "cherry-pick-311c502e88d9.patch" ]||
				[ "$i" = "cherry-pick-318948133839.patch" ]||
				[ "$i" = "cherry-pick-d6247827bfd0.patch" ]||
