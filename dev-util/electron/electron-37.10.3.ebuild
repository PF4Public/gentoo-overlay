...
CHROMIUM_VERSION="138.0.7204.185"
CHROMIUM_P="chromium-${CHROMIUM_VERSION}"
NODE_VERSION="22.21.1"
NODE_P="node-v${NODE_VERSION}"
UGC_PVR="138.0.7204.168-1"
...
PPC64_HASH="28cd49aaf2a3163af95f7f15b9a70ecfe07aed38"
...
SRC_URI="mirror+https://commondatastorage.googleapis.com/chromium-browser-official/${CHROMIUM_P}-lite.tar.xz
	...
	https://registry.yarnpkg.com/lint-staged/-/lint-staged-10.5.4.tgz
...
src_prepare() {
	...
	if use system-abseil-cpp; then
		...
		eapply "${FILESDIR}/chromium-138-system-abseil.patch"
