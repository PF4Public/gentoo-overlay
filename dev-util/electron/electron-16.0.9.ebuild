...
PATCHSET="4"
PATCHSET_NAME="chromium-96-patchset-${PATCHSET}"
...
SRC_URI="https://commondatastorage.googleapis.com/chromium-browser-official/${CHROMIUM_P}.tar.xz
	...
	https://registry.yarnpkg.com/@electron/docs-parser/-/docs-parser-0.12.2.tgz -> @electron-docs-parser-0.12.2.tgz
...
src_unpack() {
	...
	use ppc64 && unpack "${PPC64LE_PATCHSET_NAME}.tar.xz"
}
...
src_prepare() {
	...
	if ! use custom-cflags; then #See #25 #92
		sed -i '/default_stack_frames/Q' "${WORKDIR}/patches/chromium-96-compiler.patch" || die
	fi
	...
	sed -i '/web_tests/Q' "patches/chromium/fire_iframe_onload_for_cross-origin-initiated_same-document.patch" || die
	...
	use ppc64 && PATCHES+=(
		...
		"${FILESDIR}/ppc64le/fixes/libpng-pdfium-compile-96.patch"
	)
