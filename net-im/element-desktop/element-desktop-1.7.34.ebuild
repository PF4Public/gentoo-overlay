...
SRC_URI="!build-online? (
	https://codeload.github.com/matrix-org/eslint-plugin-matrix-org/tar.gz/50d6bdf6704dd95016d5f1f824f00cac6eaa64e1
	...
	https://registry.yarnpkg.com/jszip/-/jszip-3.6.0.tgz
...
src_compile() {
	...
	node /usr/bin/yarn run build:ts || die
	node /usr/bin/yarn run build:res || die
