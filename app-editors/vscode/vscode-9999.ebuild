...
SRC_URI+="
	...
	https://registry.yarnpkg.com/typescript/-/typescript-4.0.0-dev.20200715.tgz
...
LICENSE="MIT"
SLOT="0"
IUSE="builtin-extensions openvsx substitute-urls"
...
src_prepare() {
	...
	#Is it OK? vvv
	sed -i 's/"ms-vscode.vscode-js-profile-flame",/"ms-vscode-remote.remote-containers","ms-vscode-remote.remote-ssh","ms-vsliveshare.vsliveshare","ms-vscode.vscode-js-profile-flame",/' product.json.bak || die
