...
export CHROME_DESKTOP="cromite-browser-bin-cromite-bin.desktop"

exec -a "cromite-browser-bin" "$PROGDIR/chrome" --extra-plugin-dir=/usr/lib/nsbrowser/plugins ${CHROMIUM_FLAGS} "$@"
