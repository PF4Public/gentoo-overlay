...
src_configure() {
	...
	echo "$@"
	"$@" || die "Failed to configure Cromite"
...
src_install() {
	...
	local CHROMIUM_HOME="/usr/$(get_libdir)/cromite-browser${browser_suffix}"
	...
	dosym "${CHROMIUM_HOME}/chromium-launcher.sh" /usr/bin/cromite-browser${browser_suffix}
	# keep the old symlink around for consistency
	dosym "${CHROMIUM_HOME}/chromium-launcher.sh" /usr/bin/cromite${browser_suffix}

	use enable-driver && dosym "${CHROMIUM_HOME}/chromedriver" /usr/bin/cromite-chromedriver${browser_suffix}
	...
	newicon -s 128 chrome/app/theme/chromium/win/tiles/SmallLogo.png cromite-browser${browser_suffix}.png
	...
	domenu out/Release/cromite-browser${browser_suffix}.desktop

	# Install GNOME default application entry (bug #303100).
	insinto /usr/share/gnome-control-center/default-apps
	doins out/Release/cromite-browser${browser_suffix}.xml

	# Install AppStream metadata
	insinto /usr/share/appdata
	doins out/Release/cromite-browser${browser_suffix}.appdata.xml

	# Install manpage; bug #684550
	doman out/Release/cromite-browser${browser_suffix}.1
	dosym cromite-browser${browser_suffix}.1 /usr/share/man/man1/cromite${browser_suffix}.1
