...
UGC_COMMIT_ID="d9a405d70bbe8882f7547f21869c0537a97ccd4a"
...
src_prepare() {
	...
	use ppc64 && PATCHES+=(
		...
		"${FILESDIR}/ppc64le/sandbox/0001-sandbox-linux-Update-syscall-helpers-lists-for-ppc64.patch"
		...
		"${FILESDIR}/ppc64le/libaom/0001-Add-ppc64-target-to-libaom.patch"
		...
		"${FILESDIR}/ppc64le/third_party/use-sysconf-page-size-on-ppc64.patch"
		"${WORKDIR}/debian/patches/disable/swiftshader.patch"
		"${FILESDIR}/disable/swiftshader-2.patch"
